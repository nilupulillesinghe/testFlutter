                          ...
                          child: Column(
                            ...
                            children: [
                              Container(
                                ...
                                child: Text("Register",style: TextStyle(color: primaryColor,fontWeight: FontWeight.bold,fontSize: 18),),
                              ),
                              SizedBox( height: 20,),
                              Container(
                                width: MediaQuery.of(context).size.width*0.8,
                                ...
                                child: TextFormField(
                                  ...
                                  style: TextStyle(fontSize: MediaQuery.of(context).size.width * 0.04,color: Color(0XFF818181),),
                                  decoration: InputDecoration(
                                    border: InputBorder.none,
                                    filled: true,
                                    fillColor: Colors.white,
                                    hintText: "Username",
                                    hintStyle: TextStyle(color: Color(0XFF818181),fontSize: MediaQuery.of(context).size.width * 0.04,fontWeight: FontWeight.w300),
                              ...
                              Container(
                                ...
                                child: TextFormField(
                                  validator: (value) {
                                    if (value == null || value.isEmpty) {
                                      return 'This field is required.';
                                    } else if(!_emailController.value.text.contains("@") || !_emailController.value.text.contains(".")){
                              ...
                              Container(
                                ...
                                child: TextFormField(
                                  validator: (value) {
                                    if (value == null || value.isEmpty) {
                                      return 'This field is required.';
                                    } else if(_passwordController.value.text != _passwordRepeatController.value.text){
                              ...
                              GestureDetector(
                                onTap: () async {
                                  if (_registerFormKey.currentState!.validate()) {
                                    UserModel userModel = new UserModel(_userNameController.value.text, _emailController.value.text, generateMd5(_passwordController.value.text));
                              ...
                              Container(
                                ...
                                child: Padding(
                                  ...
                                  child: GestureDetector(
                                      ...
                                      child: Text("SignIn",style: TextStyle(color: primaryColor,fontWeight: FontWeight.bold,fontSize: 12),)
                                  ),
                                ),
                              ),
                              SizedBox( height: 30,),
